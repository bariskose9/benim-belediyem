...
| 31 | **Her yeni dalın preview adresi Turnstile hostname listesine elle ekleniyor** | Turnstile site anahtarı alan adına kilitli ve `*.vercel.app` joker kabul edilmiyor (`vercel.app` bize ait değil, üstünde binlerce yabancı site var). Vercel her dala ayrı preview adresi verdiği için her roadmap adımında panele bir satır ekleniyor; unutulursa bot kutusu preview'da hiç çizilmiyor (`Error: 110200`) ve kodda hata aranıyor — 2026-08-02'de bu iki kez oldu. **Aynı alan adı borç #25'i de kapatır** (Resend doğrulanmış alan adı), yani tek alım iki borcu birden öder | Kendi alan adı satın alınıp sabit bir `preview.<alanadi>` tanımlanınca — bir kez eklenir, bir daha uğraşılmaz |
